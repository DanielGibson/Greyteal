...
A theme for Gtk2, Gtk3 and xfwm4, based on the Greybird Gtk2/3 theme
and the (abandoned) "Wallis" theme for xfwm4.

Basically I made the blue parts teal, made the scrollbars thicker and tweaked
the xfce4-panel tasklist settings in the gtk.css a bit for better readability.
I also put the base color (teal) in a variable (the blue color was hardcoded
all over the place) and fixed some issues with gradiants in horizontal scrollbars.

And I replaced the included xfwm4 theme with the abandoned "Wallis" theme
that I like a better than any of the still officially supported themes.

I only tested this on XFCE and didn't change anything in the folders
...
I don't care about the license for my changes, but please respect the
licenses of the original projects this is based on:


# License of the xfwm4-themes 4.10.0-2 debian package I got Wallis from:

This package was debianized by Martin Loschwitz <madkiss@debian.org> on
Sat, 19 Jul 2003 17:31:06 +0200.

You can fetch the xfwm4-themes package from the Xfce website, which is
http://www.xfce.org/

xfwm4-themes is © 2009 Olivier Fourdan but themes from several other people
were accepted. See the README in each theme-subdir for detailled infos.
...
# From Wallis' README (which is also included):
...
Created Mar. 31 2005 by Olivier Fourdan <fourdan@xfce.org>
Modified Apr. 12 2005 by Olivier Fourdan <fourdan@xfce.org>
Modified Mar. 08 2006 by Olivier Fourdan <fourdan@xfce.org>
...
Source: https://github.com/shimmerproject/Greybird

Files: *
Copyright: 2009–2016 Simon Steinbeiß, Satyajit Sahoo, Pasi Lallinaho
License: GPL-2+ or CC-BY-SA-3.0+

Files: debian/greybird.svg
Copyright: 2011 Pasi Lallinaho & Simon Steinbeiß
Comment: http://open.knome.fi/2011/03/18/xubuntu-natty-default-wallpaper/
 Bundled with Ubuntu's shimmer-themes packaging of greybird
 since https://launchpad.net/ubuntu/+source/shimmer-themes/1.1-0ubuntu1
License: GPL-2+ or CC-BY-SA-3.0+
